...
public interface SnippetService {
    ...
    ResponseEntity<SnippetDTO> getSnippetByUserIdAndName(Long userId, String name);
    ...
    ResponseEntity<String> updateSnippetStatus(Long userId, String name, SnippetStatus status);
}
