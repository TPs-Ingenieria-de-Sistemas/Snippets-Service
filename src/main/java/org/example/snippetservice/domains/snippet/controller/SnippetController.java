...
public class SnippetController {
    ...
    @ResponseBody
    public ResponseEntity<SnippetDTO> storeSnippet(
            @Valid @RequestBody CreateSnippetDTO snippet
    ) {
    ...
    public ResponseEntity<SnippetDTO> getSnippet(
            @PathVariable String userId, @PathVariable String name) {
        Jwt jwt = (Jwt) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    ...
    public ResponseEntity<String> deleteSnippet(
            @PathVariable String name, @PathVariable String userId) {
        Jwt jwt = (Jwt) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ResponseEntity<String> updateSnippetStatus(
            @PathVariable String userId, @PathVariable String name, @Valid @RequestBody SnippetStatusInputDTO status) {
        // TODO
        Jwt jwt = (Jwt) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
